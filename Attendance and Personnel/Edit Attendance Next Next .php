                                        ...
                                        <?php
											...
											$content=$content.'
															...
															<div class="form-group">
																...
																<input class="form-control" placeholder="'.$row2['0'].'" value="'.$row2['0'].'" name="sick_leave_balance">
															</div>
															
															<div class="form-group">
																<label>Vacation Leave Balance</label>
																<input class="form-control" placeholder="'.$row2['1'].'" value="'.$row2['1'].'" name="vac_leave_balance">
															</div>
