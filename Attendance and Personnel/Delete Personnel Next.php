...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Delete Personnel</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="delete_personnel.php" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                        <?php
											...
											$content=$content.'
															...
															<input class="form-control" placeholder="'.$row['0'].'" value="'.$row['0'].'" name="staff_id" readonly>
															</div>
															<div class="form-group">
															...
															<div class="form-group">
																<label>Address</label>
																<input class="form-control" placeholder="'.$row['4'].'" value="'.$row['4'].'" name="address" readonly>
															</div>
															<div class="form-group">
																<label>Contact</label>
																<input class="form-control" maxlength="11" placeholder="'.$row['5'].'" value="'.$row['5'].'" name="contact_number" readonly>
															</div>
															<div class="form-group">
																<label>Email</label>
																<input class="form-control" type="email" placeholder="'.$row['6'].'" value="'.$row['6'].'" name="email_address" readonly>
															</div>
										
															<div class="form-group">
																<label>Staff type:</label>
																<input class="form-control" placeholder="'.$row['7'].'" value="'.$row['7'].'" name="staff_type" readonly>
															</div>
