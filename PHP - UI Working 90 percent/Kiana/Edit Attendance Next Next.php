                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       <li >
                        ...
                        <li>
                            <a href="Add Attendance.php"><i class="fa fa-plus-circle fa-fw"></i> Add Personnel</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="update_attendance_record.php" method="POST" onsubmit="return confirm('Are you sure you want to make changes to this record?'); >
                                        <?php
											...
											$content=$content.'
															...
															<div class="form-group">
																...
																<input class="form-control" placeholder="'.$row['5'].'" value="'.$row['5'].'" name="start" maxlength="10" required pattern="^\d{4}\-(0?[1-9]|1[012])\-(0?[1-9]|[12][0-9]|3[01])$">
															</div>
                                          
															<div class="form-group">
																<label>End Date</label>
																<input class="form-control" placeholder="'.$row['6'].'" value="'.$row['6'].'" name="end" maxlength="10" required pattern="^\d{4}\-(0?[1-9]|1[012])\-(0?[1-9]|[12][0-9]|3[01])$">
															</div>
