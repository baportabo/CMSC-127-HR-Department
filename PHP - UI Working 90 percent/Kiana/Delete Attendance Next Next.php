                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="delete_attendance_record.php" method="POST" onsubmit="return confirm('Are you sure you want to delete to this record?'); >
                                        <?php
											...
											$content=$content.'
															...
															<div class="form-group">
																...
																<input class="form-control" placeholder="'.$row['5'].'" value="'.$row['5'].'" name="start" maxlength="10" readonly>
															</div>
                                          
															<div class="form-group">
																<label>End Date</label>
																<input class="form-control" placeholder="'.$row['6'].'" value="'.$row['6'].'" name="end" maxlength="10" readonly>
															</div>
